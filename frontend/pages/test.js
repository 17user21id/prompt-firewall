    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="card bg-blue-50 border-blue-200">
          <h2 className="text-lg font-semibold text-blue-900 mb-3">Try These Examples:</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <h3 className="font-medium text-blue-800 mb-2">PII Detection:</h3>
            ...
            <div>
              <h3 className="font-medium text-blue-800 mb-2">Injection Attempts:</h3>
              <ul className="space-y-1 text-blue-700">
          ...
          <div className="card">
            <div className="flex items-center justify-center py-12">
              <div className="flex items-center space-x-3">
                <div className="spinner"></div>
                <span className="text-gray-600">Analyzing prompt for security risks...</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="card text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">Injection Prevention</h3>
            <p className="text-sm text-gray-600">
